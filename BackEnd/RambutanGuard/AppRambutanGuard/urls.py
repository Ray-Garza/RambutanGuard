...
from AppRambutanGuard.views import RegisterEmpleadoView, EliminarEmpleadoView, ValidarAsistenciaView, DisplayService
...
urlpatterns = [
    ...
    path('exportar-reporte/', DisplayService.as_view(), name='exportar-reporte')
]
